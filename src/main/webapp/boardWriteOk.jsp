...
<body>
	...
	<%
		...
		// SQL문 만들기
		String sql = "INSERT INTO board (btitle, bcontent, memid) VALUES ('"+ btitle +"', '"+ bcontent +"', '"+ memid +"')";
		
		Connection conn = null; // 커넥션 인터페이스로 선언 후 null로 초기값 선언
		Statement stmt = null; // sql문을 실행, 관리해주는 객체를 선언해주는 인터페이스로 stmt 선언 및 null로 초기값
